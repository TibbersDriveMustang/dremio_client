...
try:
    ...
    def connect(
        ...
        if username and password:
            ...
            # token_pair = client.authenticate_basic_token(username, password, initial_options)
            # client.authenticate(HttpDremioClientAuthHandler(username, password if password else ""), initial_options)
